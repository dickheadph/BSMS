	...
	<div class="container content2">
		...
		<div class="row">
			...
			<div class="coll3 col-sm-7 col-md-7 col-lg-7">
				<h2 class="cert"><u><b> BARANGAY CLEARANCE </b></u></h2>
				<br> <br> <br>
				...
				?>
				<p class="parag"> 
					&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp This is to certify that <u><b> <?php echo strtoupper($resFull)?> </b></u>, of legal age, <?php echo strtolower($resStatus);?>, Filipino, resident of and with postal address at <b> Zone <?php echo $resZone;?> </b>, Sta. Elena, Baras, Nabua Camarines Sur, a registered person in this barangay. A person of good moral character and a law abiding citizen of the community and has no derogatory information nor complaint of whatever nature against him/her, which this office is aware of.
				</p>
				<p class="parag"> 
					&nbsp&nbsp&nbsp&nbsp&nbsp Any help is extended to the bearer will be highly appreciated by the undersigned. 
				</p>
				<p class="parag">
				...
				<p class="applicant">Applicant's Signature</p>

				<br> <br>

				<p>OR Number:</p>
				<p>Clearance Amount:</p>

				<p class="name"><b> HON. HERMIE C. SAMUDIO SR. </b></p>
				<p class="designation"> Punong Barangay </p>

				<p> <b> For <u><?php echo $purpose;?></u> purposes </b> </p>

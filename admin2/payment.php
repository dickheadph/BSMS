...
<head>
	...
	<style type="text/css">
		...
		@media print {
			.tbl th:nth-child(6) { display: none; }
	        .tbl td:nth-child(6) { display: none; }
	    }
...
<body class="fixed-nav sticky-footer" id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion" style="background-color: #c2523e;">
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Payment Reports">
					<a class="nav-link active" href="payment.php?adminID=<?php echo ($adminID)?>" style="color: white;">
		...
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				<li class="breadcrumb-item">
					<a href="payment.php?adminID=<?php echo($adminID)?>">Reports</a>
				</li>
					...
					<tbody>
						<?php
							if(isset($_POST['search'])){
								$date1 = $_POST['date1'];
								$date2 = $_POST['date2'];
								$query=mysqli_query($con, "SELECT * FROM `payment` WHERE DATE(pDateTime) BETWEEN '$date1' AND '$date2' ORDER BY pDateTime DESC") or die(mysqli_error());
						...
						?>
							<tr>
								<td><?php echo $fetch['orNum'] ?></td>
	    						<td><?php echo date("M d, Y H:i A", strtotime ($fetch['pDateTime']))?></td>
	    						...
	    						<td>
	    							<button type="button" class="btn btn-primary btn-xs dt-edit" data-placement="bottom" title="Edit" data-toggle="modal" data-target="#update_modal<?php echo $fetch['payID'] ?>">
					    			<i class="fa fa-fw fa-edit"></i>
					    		</button>
	    						</td>
							</tr>
							<!-- Update Modal-->
	    					<div class="modal fade" id="update_modal<?php echo $fetch['payID'] ?>" aria-hidden="true">
									...
									<div class="modal-content">
										<form method="POST" action="" enctype="multipart/form-data">
											...
											<div class="modal-body" style="color: white">
												<div class="row">
													<input type="hidden" name="payID" value="<?php echo $fetch['payID']?>">
													<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
														<i class="fa fa-file"></i> <label class="control-label">Type of Document</label>
														<div class="form-group">
															<input type="text" name="type" class="form-control col-xs-4" value="<?php echo ucwords($fetch['type'])?>" readonly>
														</div>

														<i class="fa fa-user"></i> <label class="control-label">Payer</label>
														<div class="form-group">
															<input type="text" name="payer" class="form-control col-xs-4" value="<?php echo ucwords($fullName)?>" readonly>
														</div>

														<i class="fa fa-user"></i> <label class="control-label">Amount</label>
														<div class="form-group">
															<input type="number" name="amount" class="form-control col-xs-4" value="<?php echo $fetch['amount'].'.00'?>" readonly>
														</div>
													</div>
													<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
														<i class="fa fa-user"></i> <label class="control-label">OR Number</label>
														<div class="form-group">
															<input type="number" name="orNum" class="form-control col-xs-4" value="<?php echo $fetch['orNum']?>" required>
														</div>

														<i class="fa fa-money"></i> <label class="control-label">Receipt</label>
														<div class="form-group">
															<input type="file" name="file">
														</div>
														<img src="../receipt/<?php echo($fetch['receipt'])?>">
													</div>
												</div>
												<div class="modal-footer">
													<button type="submit" name="update" class="btn" style="background-color: #f8a698"><span class="fa fa-edit"></span> Update</button>
						...
						<?php
								...
								$query=mysqli_query($con, "SELECT * FROM `payment` ORDER BY pDateTime DESC") or die(mysqli_error());
								while($fetch=mysqli_fetch_array($query)){
									@$total += $fetch['amount'];
						?>
							<tr>
	...
	<script type="text/javascript">
			...
			buttons: [
				{
					...
					customize: function (win) {
		                ...
		                $(win.document.body).find('h1').css('font-size','20px').text('Total Collection');
	    ...
	    $('#dataTable').append('<caption style="float: right;"><b>Total: '+<?php echo $total; ?>+'.00</b></caption>');
	</script>
</body>
</html>